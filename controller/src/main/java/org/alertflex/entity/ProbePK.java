 ...
 */
@Embeddable
public class ProbePK implements Serializable {
    ...
    public ProbePK(String refId, String node, String name) {
        this.refId = refId;
        this.node = node;
        this.name = name;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProbePK)) {
            return false;
        }
        ProbePK other = (ProbePK) object;
    ...
    public String toString() {
        return "org.alertflex.entity.ProbePK[ refId=" + refId + ", node=" + node + ", name=" + name + " ]";
    }
