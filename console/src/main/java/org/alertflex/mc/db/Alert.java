...
public class Alert implements Serializable {
    ...
    public String getColorSeverity() {
        if (alertSeverity == 3) return "font-size: 200%; color: red; font-weight: 600; ";
        else {
            if (alertSeverity == 2) return "font-size: 200%; color: orange; font-weight: 600; ";
            else {
                if (alertSeverity == 1) return "font-size: 200%; color: green; font-weight: 600; ";
            }
        }
    ...
    public String toString() {
        return "org.alertflex.ids.db.Alert[ alertId=" + alertId + " ]";
    }
