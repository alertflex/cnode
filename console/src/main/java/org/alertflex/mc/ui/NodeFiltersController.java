...
public class NodeFiltersController implements Serializable {
    ...
    public void openFile() {
        ...
        try {
            ...
            message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Action result: ","Filters have been loaded.");
    ...
    public void saveFile() {
        ...
        try {
            ...
            message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Action result: ","Filters have been saved.");
