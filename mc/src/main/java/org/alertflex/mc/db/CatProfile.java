...
@NamedQueries({
    ...
    , @NamedQuery(name = "CatProfile.findByCpDesc", query = "SELECT c FROM CatProfile c WHERE c.cpDesc = :cpDesc")
    , @NamedQuery(name = "CatProfile.findByCpSource", query = "SELECT c FROM CatProfile c WHERE c.cpSource = :cpSource")
    , @NamedQuery(name = "CatProfile.findByCatNames", query = "SELECT c FROM CatProfile c WHERE c.catNames = :catNames")
...
public class CatProfile implements Serializable {
    ...
    public CatProfile(Integer cpId, String refId, String cpName, String cpDesc, String cpSource, String catNames) {
        this.cpId = cpId;
        this.refId = refId;
        this.cpName = cpName;
        this.cpDesc = cpDesc;
    ...
    public String toString() {
        return "org.alertflex.mc.db.CatProfile[ cpId=" + cpId + " ]";
    }
