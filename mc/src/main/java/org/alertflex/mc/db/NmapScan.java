...
public class NmapScan implements Serializable {
    ...
    public NmapScan(Long recId, String refId, String host, String protocol, int portId, String state, String name) {
        this.recId = recId;
        this.refId = refId;
        this.host = host;
    ...
    public String toString() {
        return "org.alertflex.mc.db.NmapScan[ recId=" + recId + " ]";
    }
