...
@NamedQueries({
    ...
    , @NamedQuery(name = "ScanJob.findByTimerange", query = "SELECT s FROM ScanJob s WHERE s.timerange = :timerange")
...
public class ScanJob implements Serializable {
    ...
    public ScanJob(Integer recId, String name, String playbook, int playId, String refId, String scanType, String value1, String value2, int value3, int timerange, String description, int errorExit) {
        this.recId = recId;
        this.name = name;
    ...
    public String toString() {
        return "org.alertflex.mc.db.ScanJob[ recId=" + recId + " ]";
    }
