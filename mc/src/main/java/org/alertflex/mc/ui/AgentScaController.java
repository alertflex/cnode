...
import org.alertflex.mc.services.AgentScaFacade;



@ManagedBean
@ViewScoped
public class AgentScaController implements Serializable {
    ...
    private List<AgentSca> listAgentSca;
    ...
    public void updateList() {
        ...
        listAgentSca = agentScaFacade.findSca(session_tenant, selectedNodeId, selectedAgentName);
        
        if (listAgentSca == null) listAgentSca = new ArrayList();
        
    }

    public List<AgentSca> getListAgentSca() {
        
        return listAgentSca;
    }
    
    public void getListAgentSca(List<AgentSca> lsca) {
        
        this.listAgentSca = lsca;
    }
    
    public void deleteRecord(AgentSca as) {
        
        if(as != null) {
            
            try {
                
                agentScaFacade.remove(as);
