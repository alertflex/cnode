    ...
    public void openRule() {
        ...
        if (!selectedSensor.isEmpty() && !selectedRule.isEmpty()) {
            try {
                ...
                message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Result: ","IDS rule has been loaded.");
    ...
    public void saveRule() {
        ...
        if (!selectedSensor.isEmpty() && !fileName.isEmpty() && !rulePayload.isEmpty() && !rulePayload.equals("error")) {
            ...
            try {
                ...
                message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Result: ","IDS rule has been saved.");
    ...
    public void sendRule() throws IOException {
        ...
        if (!selectedSensor.isEmpty() && !fileName.isEmpty() && !rulePayload.isEmpty() && !rulePayload.equals("error")) {
            ...
            try {
                ...
                msg.setStringProperty("content_type", "rules");
                msg.setStringProperty("rule_name", fileName);
                msg.setIntProperty("rule_reload", 1);
                
                msg.setStringProperty("sensor", sensor);
                msg.setIntProperty("rules_type", rulesType);
                ...
                message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Result: ","IDS rule has been sent.");
    ...
    public void uploadRule(FileUploadEvent event) throws IOException {
        ...
        if (!uploadedFileName.isEmpty()) {
            ...
            try {
                ...
                message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Result: ","IDS rule has been uploaded.");
